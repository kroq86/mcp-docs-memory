---
layout: page
title: "Why Docs-Memory Beats the Pure Karpathy Approach"
description: "A technical article explaining why docs-memory-mcp improves on pure prompt-context workflows with DuckDB, Ollama embeddings, vector search, durable memory, and MCP tools."
permalink: /
